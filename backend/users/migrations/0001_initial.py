    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Юзернейм неверный!', regex='^[\\w.@+-]+$')], verbose_name='Уникальный юзернейм')),
